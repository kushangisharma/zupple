...
var NumberInput = React45.forwardRef(function NumberInput2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime29.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime28.jsx)(DecrementButton, _extends({}, decrementButtonProps)), (0, import_jsx_runtime28.jsx)(IncrementButton, _extends({}, incrementButtonProps)), startAdornment, (0, import_jsx_runtime28.jsx)(Input3, _extends({}, inputProps)), endAdornment]
  }));
});
...
var TransitionContext = React51.createContext(null);

// node_modules/@mui/base/useTransition/useTransitionStateManager.js
function useTransitionStateManager() {
  const transitionContext = React52.useContext(TransitionContext);
...
function useTransitionTrigger(requestEnter) {
  const [state, dispatch] = React53.useReducer(transitionStateReducer, {
    elementExited: !requestEnter,
    inProgress: false
  });
  const hasTransition = React53.useRef(false);
  const handleEntering = React53.useCallback(() => {
    dispatch("entering");
  }, []);
  const handleEntered = React53.useCallback(() => {
    dispatch("entered");
  }, []);
  const handleExiting = React53.useCallback(() => {
    dispatch("exiting");
  }, []);
  const handleExited = React53.useCallback(() => {
    dispatch("exited");
  }, []);
  React53.useEffect(() => {
  ...
  const registerTransition = React53.useCallback(() => {
...
var PopupContext = React54.createContext(null);
...
var Popup = React55.forwardRef(function Popup2(props, forwardedRef) {
  ...
  const popupContextValue = React55.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
...
true ? Popup.propTypes = {
   ...
   */
  middleware: import_prop_types22.default.arrayOf(import_prop_types22.default.oneOfType([import_prop_types22.default.oneOf([false]), import_prop_types22.default.shape({
    fn: import_prop_types22.default.func.isRequired,
    name: import_prop_types22.default.string.isRequired,
    options: import_prop_types22.default.any
  })])),
  /**
   ...
   */
  offset: import_prop_types22.default.oneOfType([import_prop_types22.default.func, import_prop_types22.default.number, import_prop_types22.default.shape({
    alignmentAxis: import_prop_types22.default.number,
    crossAxis: import_prop_types22.default.number,
    mainAxis: import_prop_types22.default.number
  })]),
  /**
   ...
   * @default false
   */
  withTransition: import_prop_types22.default.bool
} : void 0;
...
var Select = React58.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime36.jsxs)(React58.Fragment, {
    ...
    })), buttonDefined && (0, import_jsx_runtime35.jsx)(PopperComponent, _extends({}, popperProps, {
...
var Switch = React64.forwardRef(function Switch2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime41.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime40.jsx)(Track, _extends({}, trackProps)), (0, import_jsx_runtime40.jsx)(Thumb, _extends({}, thumbProps)), (0, import_jsx_runtime40.jsx)(Input3, _extends({}, inputProps))]
  }));
});
...
var TablePagination = React66.forwardRef(function TablePagination2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime44.jsx)(Root, _extends({}, rootProps, {
    children: (0, import_jsx_runtime45.jsxs)(Toolbar, _extends({}, toolbarProps, {
      ...
      })), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime44.jsx)(Select3, _extends({}, selectProps, {
...
var _excluded30 = ["children", "className", "lastTransitionedPropertyOnEnter", "lastTransitionedPropertyOnExit", "enterClassName", "exitClassName"];
function CssTransition(props) {
  ...
  const [isEntering, setIsEntering] = React79.useState(!requestedEnter);
  React79.useEffect(() => {
    if (requestedEnter) {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-4AERJXFG.js.map
